...
export default function SkillsChart() {
  ...
  const COLORS = ["#e11d48", "#be123c", "#f43f5e", "#9f1239", "#881337"]
  ...
  const tooltipBorderColor = "#e11d48"
      ...
      <div className="container mx-auto px-4" ref={ref}>
        ...
        <Tabs defaultValue="distribution" className="w-full">
          <TabsList className="grid w-full max-w-md mx-auto grid-cols-3 mb-12">
            <TabsTrigger
              value="distribution"
              className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-rose-600 data-[state=active]:to-red-700 data-[state=active]:text-white data-[state=active]:shadow-[0_0_10px_rgba(225,29,72,0.3)]"
            >
              Distribution
            </TabsTrigger>
            <TabsTrigger
          ...
          <TabsContent value="distribution">
            ...
            >
              <motion.div variants={itemVariants}>
                <Card className="bg-gray-900/40 backdrop-blur-sm border-0 overflow-hidden hover:shadow-lg hover:shadow-rose-500/10 transition-all duration-300 h-full p-6">
