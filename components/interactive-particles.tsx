...
export default function InteractiveParticles() {
  ...
  const [colorTheme, setColorTheme] = useState<"rainbow" | "rose" | "cyan" | "amber">("rose")
  ...
  const colorPalettes = {
    ...
    rose: ["#e11d48", "#be123c", "#f43f5e", "#9f1239", "#881337"],
  ...
  const techIcons = [
    ...
    { type: "video", icon: <Film className="text-red-500" /> },
  ]
    ...
    <section id="game" className="py-20 bg-gradient-to-b from-gray-950 to-black dark:from-gray-100 dark:to-white">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="w-20 h-1 bg-gradient-to-r from-rose-500 to-red-700 mx-auto mb-8"></div>
              ...
              <Button
                ...
                className={`rounded-full ${
                  mode === "attract"
                    ...
                    : "border-rose-500 text-white dark:text-gray-800"
                }`}
              >
