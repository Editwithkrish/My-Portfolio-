      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className={`flex flex-col ${reverse ? "md:flex-row-reverse" : "md:flex-row"} items-center gap-12`}>
          <motion.div style={{ y: y.pipe((v) => v * -0.2), opacity, scale }} className="w-full md:w-1/2">
            <div className="text-center md:text-left">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="w-20 h-1 bg-gradient-to-r from-rose-500 to-red-500 mx-auto md:mx-0 mb-6"
              />
          ...
          <motion.div style={{ y: y.pipe((v) => v * 0.2), rotate, scale }} className="w-full md:w-1/2">
            <div className="relative h-[400px] w-full overflow-hidden rounded-2xl border-2 border-rose-500/20 shadow-[0_0_25px_rgba(225,29,72,0.2)]">
