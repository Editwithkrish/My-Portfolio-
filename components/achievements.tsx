    ...
    <section id="achievements" className="py-20 bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <motion.div
          ...
          animate={{
            background: [
              "radial-gradient(circle at 20% 30%, rgba(225, 29, 72, 0.15) 0%, transparent 70%)",
              "radial-gradient(circle at 80% 70%, rgba(225, 29, 72, 0.15) 0%, transparent 70%)",
              "radial-gradient(circle at 20% 30%, rgba(225, 29, 72, 0.15) 0%, transparent 70%)",
            ],
          }}
          ...
          <div className="relative">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="relative"
              >
                <Card className="bg-gradient-to-br from-gray-900 to-black border border-rose-500/10 shadow-[0_0_25px_rgba(225,29,72,0.15)] overflow-hidden">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2">
                      <div className="relative h-64 md:h-auto overflow-hidden">
                        ...
                        <div className="absolute top-4 left-4 z-10">
                          ...
                          >
                            <Badge className="px-3 py-1.5 text-lg font-bold bg-rose-500 text-white border-0">
                      ...
                      <div className="p-8 md:p-10">
                        ...
                        >
                          ...
                          <p className="text-rose-400 mb-4">{achievements[activeAchievement].date}</p>
                          ...
                          <div className="mb-6">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {achievements[activeAchievement].technologies.map((tech, index) => (
                                ...
                                >
                                  <Badge
                                    className="bg-gray-800 hover:bg-gray-700 text-gray-300 border-rose-500/20"
                                    variant="outline"
                                  >
                                    {tech}
                                  </Badge>
                          ...
                          <Link
                            ...
                            className="inline-flex items-center text-rose-400 hover:text-rose-300 transition-colors"
                          >
            ...
            {/* Navigation buttons */}
            <motion.button
              className="absolute left-4 top-1/2 transform -translate-y-1/2 w-10 h-10 rounded-full bg-black/50 backdrop-blur-sm border border-rose-500/20 flex items-center justify-center text-white z-10 hover:bg-rose-500/20 transition-colors"
            ...
            <motion.button
              className="absolute right-4 top-1/2 transform -translate-y-1/2 w-10 h-10 rounded-full bg-black/50 backdrop-blur-sm border border-rose-500/20 flex items-center justify-center text-white z-10 hover:bg-rose-500/20 transition-colors"
