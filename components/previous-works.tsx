    ...
    <section id="previous-works" className="py-20 bg-gradient-to-b from-black to-gray-950">
      <div className="container mx-auto px-4" ref={ref}>
        ...
        <motion.div
          ...
          className="mb-20"
        >
          <div className="relative overflow-hidden rounded-xl shadow-[0_0_25px_rgba(225,29,72,0.2)] bg-gray-900/50 backdrop-blur-sm">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
                  ...
                  <Button
                    asChild
                    className="bg-gradient-to-r from-rose-600 to-red-600 hover:from-rose-700 hover:to-red-700 text-white rounded-full px-6"
                  >
            ...
            <div className="absolute top-1/2 left-4 transform -translate-y-1/2">
              <Button
                ...
                className="rounded-full bg-black/50 hover:bg-rose-500/30 text-white h-10 w-10 sm:h-12 sm:w-12"
              >
              ...
              {websites.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all duration-300 ${
                    currentFeatured === index ? "bg-rose-500 w-6" : "bg-gray-500 hover:bg-gray-400"
                  }`}
                >
          ...
          {categories.map((category) => (
            <Button
              ...
              className={`rounded-full px-6 ${
                filter === category.id
                  ? "bg-gradient-to-r from-rose-600 to-red-600 text-white border-0 shadow-[0_0_10px_rgba(225,29,72,0.3)]"
                  : "border-rose-500 text-white hover:bg-rose-500/20"
              }`}
            >
          ...
          >
            ...
            >
              {filteredWebsites.map((website) => (
                ...
                >
                  <Card className="bg-gray-800/40 backdrop-blur-sm border-0 overflow-hidden group hover:shadow-xl hover:shadow-rose-500/20 transition-all duration-300 h-full">
                    <div className="relative overflow-hidden h-48">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-between p-4">
                        <Button
                          asChild
                          variant="ghost"
                          className="rounded-full bg-rose-500/20 hover:bg-rose-500/40 text-white"
                        >
