        ...
        >
          {skillCategories.map((category, categoryIndex) => (
            <motion.div key={categoryIndex} variants={itemVariants}>
              <Card className="bg-gray-800/40 backdrop-blur-sm border-0 overflow-hidden hover:shadow-lg hover:shadow-rose-500/10 transition-all duration-300 h-full">
                <CardContent className="p-6">
                  <h3 className="text-xl font-bold mb-6 text-center bg-gradient-to-r from-rose-400 to-red-400 bg-clip-text text-transparent">
                    {category.category}
                  </h3>
