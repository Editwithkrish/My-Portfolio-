...
export default function DownloadCV() {
  ...
  const cvFileUrl = "https://drive.google.com/file/d/1DLs_gHwcmBfoLJEYsBY7UiNMvPg0O-71/view?usp=sharing"
  
  // Google Drive direct download link (converted from sharing link)
  const directDownloadUrl = "https://drive.google.com/uc?export=download&id=1DLs_gHwcmBfoLJEYsBY7UiNMvPg0O-71"
    ...
    <section id="download-cv" className="py-20 bg-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10" ref={ref}>
        ...
        <div className="max-w-5xl mx-auto">
          <Card className="bg-gradient-to-br from-gray-900 to-black border border-rose-500/10 shadow-[0_0_15px_rgba(225,29,72,0.1)] overflow-hidden">
            <CardContent className="p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  ...
                  >
                    ...
                    <div className="space-y-4 mb-8">
                      {cvHighlights.map((highlight, index) => (
                        <motion.div
                          ...
                          whileHover={{ x: 5 }}
                        >
                          <CheckCircle className="h-5 w-5 text-rose-500 mr-3 mt-0.5 shrink-0 group-hover:text-rose-400 transition-colors" />
                    ...
                    >
                      <Button
                        ...
                        className="bg-gradient-to-r from-rose-600 to-red-700 hover:from-rose-700 hover:to-red-800 text-white border-0 rounded-full px-6 py-2 font-medium transition-all shadow-[0_0_15px_rgba(225,29,72,0.3)] hover:shadow-[0_0_20px_rgba(225,29,72,0.5)]"
                      >
                        <motion.span
                      ...
                      <Button
                        ...
                        className="border-2 border-rose-500 text-white hover:bg-rose-500/20 rounded-full px-6 py-2 font-medium transition-all"
                      >
                        <motion.span
                          className="flex items-center"
                          whileHover={{ x: 3 }}
                ...
                >
                  <div className="relative w-64 h-80 bg-gradient-to-br from-gray-800 to-black rounded-lg shadow-[0_0_25px_rgba(225,29,72,0.2)] border border-rose-500/20 overflow-hidden group">
                    <motion.div
                      className="absolute inset-0 bg-gradient-to-tr from-rose-500/10 to-transparent"
                      animate={{
                        opacity: [0.2, 0.4, 0.2],
                      }}
                      transition={{
                    ...
                    <div className="absolute inset-2 bg-gray-900 rounded-lg flex flex-col items-center justify-center p-4">
                      ...
                      <h4 className="text-xl font-bold text-white mb-2">Krishna Kumar Jha</h4>
                      <p className="text-rose-400 mb-4">Full Stack Developer</p>
                      <div className="w-full h-px bg-gradient-to-r from-transparent via-rose-500/50 to-transparent mb-4"></div>
                  ...
                  >
                    ...
                    <p className="text-gray-500 text-xs mt-1">Last updated: May 2025</p>
                  </motion.div>
                </motion.div>
              </div>
            </CardContent>
