                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                          ...
                          >
                            <Button
                              asChild
                              className="bg-gradient-to-r from-rose-600 to-red-700 hover:from-rose-700 hover:to-red-800 text-white border-0 rounded-full px-8 py-6 text-lg font-medium shadow-[0_0_15px_rgba(225,29,72,0.3)] relative overflow-hidden group"
                            >
                              <Link href="#contact">
                                <motion.span
                        ...
                        <div className="bg-gray-900/50 rounded-xl p-6 border border-rose-500/10 relative overflow-hidden">
                          ...
                          <motion.div
                            ...
                            animate={{
                              background: [
                                "linear-gradient(90deg, rgba(225,29,72,0.2) 0%, transparent 25%, transparent 75%, rgba(225,29,72,0.2) 100%)",
                                "linear-gradient(90deg, rgba(225,29,72,0.2) 100%, transparent 25%, transparent 75%, rgba(225,29,72,0.2) 0%)",
                              ],
                            }}
                            transition={{
                              duration: 3,
