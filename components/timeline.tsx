      ...
      <div className="container mx-auto px-4" ref={ref}>
        ...
        >
          <div className="relative">
            {/* Vertical Line */}
            <div className="absolute left-0 md:left-1/2 transform md:-translate-x-1/2 h-full w-1 bg-gradient-to-b from-rose-500 to-red-500 rounded-full"></div>
            ...
            {timelineItems.map((item, index) => (
              ...
              >
                <div className="md:w-1/2 flex justify-center md:justify-end">
                  <div
                    className={`bg-gray-900/40 backdrop-blur-sm p-6 rounded-lg shadow-[0_0_15px_rgba(225,29,72,0.15)] max-w-md ${
                ...
                <div className="absolute left-0 md:left-1/2 transform md:-translate-x-1/2 w-8 h-8 rounded-full bg-gray-800 border-4 border-rose-500 shadow-[0_0_10px_rgba(225,29,72,0.5)] z-10"></div>
